...
/*   Updated: 2024/06/20 05:35:41 by fschuber         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_wall_texture(int start_x, int end_x, int height, mlx_texture_t *tex, double hit_offset)
{
	int				start_y;
	int				end_y;
	int				repeat_y;
	...
	while (x != end_x)
	{
		int	texture_x = (int)(hit_offset * tex->width) % tex->width;
